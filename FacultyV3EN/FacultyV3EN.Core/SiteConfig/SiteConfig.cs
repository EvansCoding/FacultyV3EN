namespace FacultyV3EN.Core.SiteConfig
{
    using FacultyV3EN.Core.Services;
    using Models.Enums;
    ...
    {
        private static string ConfigLocation => HostingEnvironment.MapPath("~/App_Data/facultyen.config");
        ...
        {
            const string cacheKey = "facultyensiteconfig";
